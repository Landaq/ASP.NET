<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmCompareValidator.aspx.cs" Inherits="DevValidationControl.FrmCompareValidator" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <hr />
            <asp:Button ID="btnComfirm" runat="server" Text="확인" />
        </div>
    </form>
</body>
</html>
