<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmCheckBoxRequiredValidationWithCustomValidator.aspx.cs" Inherits="DevValidationControl.FrmCheckBoxRequiredValidationWithCustomValidator" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script>
        //ASP.NET CustomValidator 컨트롤을 사용해서 체크박스 확인
        function ValidationConfirmCheckBox(seder, args) {
    ...
    <form id="form1" runat="server">
        <div class="form-group">
            <label for="optGender" class="col-sm-2 control-label">
                <asp:Literal ID="Literal1" runat="server">이용약관</asp:Literal>
            </label> 
            <div class="col-sm-10">
                <p>회원 이용 약관에 동의 하셔야 회원가입을 하실 수 있습니다.</p>
                ...
                <div class="checkbox">
                    <label>
                        ...
                        <asp:Literal ID="strAcceptTheLicense" runat="server">
                            위 약관에 동의 합니다.(Accept the license)
                        </asp:Literal>
                    </label>
                </div>
