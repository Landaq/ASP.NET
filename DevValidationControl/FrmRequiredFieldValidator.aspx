<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmRequiredFieldValidator.aspx.cs" Inherits="DevValidationControl.FrmRequiredFieldValidator" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:RequiredFieldValidator ID="valPassword" runat="server"
                ...
                Display="Dynamic"
                ErrorMessage="암호를입력하세요."></asp:RequiredFieldValidator>
            (필수)
            <hr />
