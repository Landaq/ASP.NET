        ...
        <div>
            ...
            <map name="GoHome">
                <area shape="circle" coords="16, 16, 5"
                    href="http://www.dotnetkorea.com/" alt="닷넷코리아" target="_blank" />
                <area shape="rect" coords="0, 0, 5, 5"
                    href="http://taeyo.net/" alt="테오닷넷" />
            </map>
            ...
            <asp:ImageMap ID="mapHome" runat="server"
                ...
                <asp:CircleHotSpot AlternateText="닷넷코리아"
                    ...
                    NavigateUrl="http://dotnetkorea.com/"
            ...
            <asp:Table ID="tblTable" runat="server" GridLines="Both">
                <asp:TableRow runat="server">
                    <asp:TableCell runat="server"
                        BackColor="Lime">1행 1열</asp:TableCell>
                    <asp:TableCell runat="server"
                        BackColor="Yellow">1행 2열</asp:TableCell>
                </asp:TableRow>
                <asp:TableRow runat="server">
                    <asp:TableCell runat="server"
                        BackColor="Blue">2행 1열</asp:TableCell>
                    <asp:TableCell runat="server"
                        BackColor="Red">2행 2열</asp:TableCell>
                </asp:TableRow>
            </asp:Table>
            <br />
