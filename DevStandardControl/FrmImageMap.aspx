    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:ImageMap ID="mapImage" runat="server" ImageUrl="~/images/img_imagemap.jpg">
                <asp:RectangleHotSpot NavigateUrl="FrmButton.aspx" Top="0" Left="0" Bottom="20" Right="120" />
                <asp:RectangleHotSpot NavigateUrl="FrmLabel.aspx" Top="20" Left="0" Bottom="40" Right="120" />
            </asp:ImageMap>
        </div>
    </form>
</body>
